  ...
  const fetchAlert = async () => {
    try {
      ...
      if (response.data.success && response.data.data) {
        ...
        if (alertData.water_level)
          setValue("water_level", alertData.water_level);
        ...
        if (alertData.temperature)
          setValue("temperature", alertData.temperature);
        ...
        setValue("is_active", Boolean(alertData.is_active))
      }
    } catch (error: any) {
      console.error("Failed to fetch alert:", error);
      toast.error(
        error?.response?.data?.message || "Không thể tải thông tin cảnh báo"
      );
    }
  };
              ...
              <div className="space-y-2">
                ...
                />
                          ...
                          <div className="flex items-center space-x-2">
                            <Checkbox
                              id="is_active"
                              checked={watch("is_active") ?? Boolean(alert.is_active)}
