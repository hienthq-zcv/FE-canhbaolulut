...
} from "@/lib/validations/admin-location";
  ...
  const fetchLocation = async () => {
    try {
      ...
      if (response.data.success && response.data.data) {
        ...
        setValue("is_monitoring", Boolean(locData.is_monitoring));
      }
    } catch (error: any) {
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground mb-2">
                  Click vào bản đồ để chọn vị trí, tọa độ sẽ tự động được điền
                  vào
                </p>
                <LocationPickerMap
                  center={
                    selectedPosition || [location.latitude, location.longitude]
                  }
                  zoom={11}
                  height="400px"
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      if (!isNaN(value)) {
                        ...
                        setValue("latitude", roundedValue, {
                          shouldValidate: true,
                        });
                        if (longitude) {
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      if (!isNaN(value)) {
                        const roundedValue =
                          Math.round(value * 1000000) / 1000000;
                        setValue("longitude", roundedValue, {
                          shouldValidate: true,
                        });
                        if (latitude) {
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  id="is_monitoring"
                  checked={
                    watch("is_monitoring") ?? Boolean(location.is_monitoring)
                  }
                  onCheckedChange={(checked) =>
                    setValue("is_monitoring", checked === true)
                  }
                />
