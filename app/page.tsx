    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative overflow-hidden gradient-hero-dark text-white">
        ...
        <div className="container relative mx-auto px-4 py-20 sm:py-32 lg:py-40">
          <div className="mx-auto max-w-5xl text-center animate-fade-in-up">
            ...
            <p className="mb-8 sm:mb-12 text-base sm:text-xl lg:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed px-4">
              Nhận cảnh báo sớm về nguy cơ lũ lụt tại địa điểm của bạn. Bảo vệ
              bản thân và gia đình với thông tin cập nhật liên tục.
            </p>
            <div
              className="flex flex-col gap-3 sm:gap-4 sm:flex-row sm:justify-center px-4 animate-fade-in-up"
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg
            className="w-full h-12 sm:h-16 fill-white dark:fill-gray-900"
      ...
      <section className="container mx-auto px-4 py-12 sm:py-16 lg:py-20 -mt-6 sm:-mt-8 relative z-10 bg-gradient-to-b from-white to-gray-50/50 dark:from-transparent dark:to-transparent">
        ...
        <div
          className="rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl border-2 sm:border-4 border-border animate-fade-in-up"
      ...
      <section className="container mx-auto px-4 py-12 sm:py-16 lg:py-20 bg-background">
        ...
        <div className="grid gap-6 sm:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          <Card
            className="card-hover border-2 border-border shadow-xl bg-card backdrop-blur-sm animate-fade-in-up hover:shadow-2xl hover:border-primary transition-all duration-300"
            style={{ animationDelay: "0.1s" }}
          >
            <CardHeader className="pb-4">
              ...
              <CardDescription className="text-base leading-relaxed text-muted-foreground">
                Nhận thông báo ngay lập tức khi có nguy cơ lũ lụt tại địa điểm
                bạn quan tâm
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          >
            <CardHeader className="pb-4">
              ...
              <CardDescription className="text-base leading-relaxed text-muted-foreground">
                Chọn và theo dõi nhiều địa điểm để nhận cảnh báo cho từng khu
                vực
              </CardDescription>
            </CardHeader>
          </Card>
        ...
        <div className="container relative mx-auto px-4">
          <div className="grid gap-8 sm:gap-12 grid-cols-1 sm:grid-cols-3">
            <div className="text-center animate-fade-in-up">
              <div className="mb-3 sm:mb-4 text-4xl sm:text-5xl lg:text-6xl font-extrabold text-blue-200">
                24/7
              </div>
              <div className="text-base sm:text-lg lg:text-xl text-blue-100 font-medium">
                Giám sát liên tục
              </div>
            </div>
            <div
